					...
					<tr>
						...
						<div id="neiye_main">
								...
								<%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_gg"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_gg where ID="&ItemID&"")
														UIcon.execute("update user_gg set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_gg where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_gg where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
